 ...
 * Client
 *
 * @ORM\Table(name="client", uniqueConstraints={@ORM\UniqueConstraint(name="client_username_key", columns={"username"}), @ORM\UniqueConstraint(name="client_email_key", columns={"email"})})
 * @ORM\Entity
 */
class Client
{
     ...
     * @var string|null
     *
     * @ORM\Column(name="username", type="string", length=48, nullable=true)
     */
    private $username;
